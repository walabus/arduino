...
#define WLAN_SSID       "cdrgap"   // cannot be longer than 32 characters!
#define WLAN_PASS       "cdrgwifi"
...
void loop(void)
{
  ...
  if (client) {
    ...
    //set value of 'value': 0 = nothing, 1 = activity!
    value = "0"; 
    ...
    if (parsed) {
      ...
      if (strcmp(action, "GET") == 0) {
        ...
        client.fastrprintln(F("Secrver: Adafruit CC3000"));
        // Send an empty line to signal start of body.
        client.fastrprintln(F(""));
        // Now send the response data.
        client.fastrprintln("<!DOCTYPE HTML>");
        client.fastrprintln("<html>");
        client.fastrprint("<h1 id=\"value\">");
        client.fastrprint(value);
        client.fastrprintln("</h1>");
        client.fastrprintln("</html>");
